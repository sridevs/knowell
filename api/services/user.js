...
user.updateName = async (email, name) => await knex('user').update({name: name}).where({email: email});

user.updateImage = async (email, image) => await knex('user').update({image: image}).where({email: email});
